...
**Last updated:** 2026-06-07 (CFO-rapport view: the buyer report now surfaces the engine's seven risk layers as a cost-of-inaction CFO view — headline trio, risk-layer table, risk→net-value bridge, justified farm-gate price, CFO callout; earlier today: crop-concentration worldwide provider foundation via CDSE openEO — Tier-1 NL BRP, Tier-2 EU CLMS, Tier-3 global WorldCover; buyer-location field + engine regression fixtures + "Adding a new region" docs; all deployed and verified live on orbag.online)

...
**Last updated:** 2026-06-07 (crop-concentration: worldwide provider foundation — tiered registry + global-keyed cache + honest method/confidence per farm; offline BRP precompute so the 15 km case computes live; literature-calibrated knobs; earlier today: buyer-location field + engine regression fixtures + "Adding a new region" docs; all deployed and verified live on orbag.online)

...
**Last updated:** 2026-06-07 (Farmer BC inhaalslag: `api/farmer.js` herschreven naar een deterministische JS-transitie-engine — meerjarig cashflow/payback-model, AI schrijft alleen narrative, regressie-fixtures, `net_value` nu opgeslagen; + consistentie-fix: certificering toegevoegd aan My Account + prefill; earlier today: CFO-rapport view; crop-concentration worldwide foundation; buyer-location field + fixtures. All deployed and verified live on orbag.online)

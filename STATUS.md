...
**Last updated:** 2026-06-07 (crop-concentration: worldwide provider foundation with REAL global layers wired via CDSE openEO — Tier-1 NL BRP, Tier-2 EU CLMS crop-type, Tier-3 global WorldCover; tiered registry + global-keyed cache + honest method/confidence per farm; literature-calibrated knobs; earlier today: buyer-location field + engine regression fixtures + "Adding a new region" docs; all deployed and verified live on orbag.online)
